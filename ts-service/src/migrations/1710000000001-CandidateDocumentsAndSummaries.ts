    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'workspace_id', type: 'varchar', length: '64', isNullable: false },
          { name: 'document_type', type: 'varchar', length: '20', isNullable: false },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'provider', type: 'varchar', length: '100', isNullable: true },
          { name: 'prompt_version', type: 'varchar', length: '50', isNullable: true },
